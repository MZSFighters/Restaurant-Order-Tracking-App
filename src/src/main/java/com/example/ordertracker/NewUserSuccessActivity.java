...
public class NewUserSuccessActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        req.doRequest(NewUserSuccessActivity.this, "custid", cv, new RequestHandler() {
            @Override
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(NewUserSuccessActivity.this, MainActivity.class);
